...
def print_utf8_text(image, xy, text, color):  # utf-8 karakterleri
    ...
    font = ImageFont.truetype("arial.ttf", 28, encoding="unic")  # font seçimi
...
# id sayacını başlat
id = 0
names = ['None', 'Barış', 'Mert', 'Ömer']

# Canlı video yakalamayı başlat
kamera = cv2.VideoCapture(0)
kamera.set(3, 2000)  # video genişliğini belirle
kamera.set(4, 1600)  # video yüksekliğini belirle
